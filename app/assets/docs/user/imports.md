...
- **It must belong to the source you chose.** A Caller's Box import accepts links
  from `ibiblio.org`; a ContraDB import accepts links from `contradb.com`. Paste
  a link from anywhere else and you get a plain message naming the hosts that do
