...
///
/// `wakelock_plus` routes through a platform channel, so pumping a Perform
/// screen without a fake throws `MissingPluginException`. Extending the
/// platform interface (rather than `implements`) satisfies
/// `PlatformInterface.verify`, so no mockito/`isMock` backdoor is needed.
///
