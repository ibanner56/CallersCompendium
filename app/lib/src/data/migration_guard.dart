...
/// consent surface can name the probable cause in plain language. Derived by
/// [SnapshotFailure] from the underlying [FileSystemException]; never trusts
/// raw exception text for control flow.
