...
///
/// Descendants that call [FirstDayOfWeekScope.of] rebuild automatically when the
/// setting changes. Use [FirstDayOfWeekScope.notifierOf] when you need to
/// *change* the setting (e.g. from the settings screen).
class FirstDayOfWeekScope
  ...
  /// scope — get the platform-locale first day of week.
