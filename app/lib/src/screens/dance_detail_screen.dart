...
class _DanceDetail {
  ...
  /// Programs in which this dance was actually called (derived query over
  /// performed slots), most-recent first. Usually empty until the separate
  /// "mark performed" write path stamps `performedAt`.
