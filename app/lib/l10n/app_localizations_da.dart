...
class AppLocalizationsDa extends AppLocalizations {
  ...
  @override
  String get settingsSyncHeader => 'Enhedssynkronisering';

  @override
  String get settingsSyncIntro =>
      'Hold dit bibliotek ajour på tværs af dine egne enheder. Enhedssynkronisering er slået fra, indtil du slår det til, og der sendes intet nogen steder hen, mens det er slået fra.';

  @override
  String get settingsSyncEnableTitle => 'Slå enhedssynkronisering til';

  @override
  String get settingsSyncEnableSubtitle =>
      'Slået fra som standard. Når du slår det til, sendes intet, før du har tilsluttet et lager.';

  @override
  String get settingsSyncWifiOnlyTitle => 'Synkronisér kun på WiFi';
  ...
  String get settingsSyncStatusNeverSynced =>
      'Tilsluttet. Endnu ikke synkroniseret.';
  ...
  String get settingsSyncExpiryWarning =>
      'Dette lager har ikke været synkroniseret i et stykke tid og fjernes efter 30 dage uden brug. Åbn appen på en tilsluttet enhed, og synkronisér for at beholde det.';
  ...
  String get settingsSyncOffline =>
      'Ingen forbindelse lige nu. Synkroniseringen kører ved næste mulighed.';
  ...
  String get settingsDateFormatCustomLegend =>
      'Tokens: yyyy eller yy = år, MM = måned (MMM = kort navn, MMMM = fuldt navn), d eller dd = dag. Separatorer: - / . , eller mellemrum.';
  ...
  String programsMatrixSemanticLabel(int danceCount, int moveCount) {
    String _temp0 = intl.Intl.pluralLogic(
      moveCount,
      locale: localeName,
      other: '$moveCount bevægelser',
      one: '1 bevægelse',
    );
    return 'Programmeringsmatrix: $danceCount danse med $_temp0';
  }
  ...
  String get importErrorCallersBoxUnsupportedHost =>
      'Det link er ikke et understøttet Caller\'s Box-link. Indsæt et link fra ibiblio.org eller www.ibiblio.org under /contradance/thecallersbox/, eller indtast dansens numeriske id.';
  ...
  String get importErrorContraDbUnsupportedHost =>
      'Det link er ikke fra en understøttet ContraDB-vært. Indsæt et link fra contradb.com eller www.contradb.com, eller indtast dansens eller programmets numeriske id.';
  ...
  String importReviewSummaryVariation(int count) {
    return 'Importeret som variation: $count';
  }
  ...
  String importReviewVariationTitle(String title) {
    return 'Variation af \"$title\"?';
  }

  @override
  String importReviewVariationBody(String title) {
    return 'Denne dans\' titel og caller matcher \"$title\", men figurerne er forskellige. Se, hvordan de adskiller sig, og vælg derefter, hvordan den skal importeres.';
  }

  @override
  String importReviewOptionVariation(String title) {
    return 'Importér som en variation af \"$title\"';
  }
  ...
  String importReviewOptionLinkBack(String title) {
    return 'Link også tilbage til \"$title\" som en relateret dans';
  }

  @override
  String get importReviewVariationAdded => 'Tilføjet';

  @override
  String get importReviewVariationRemoved => 'Fjernet';
  ...
  String importReviewVariationMoreDifferences(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count forskelle mere vises ikke',
      one: '1 forskel mere vises ikke',
    );
    return '$_temp0';
  }
  ...
  String get danceEditorMixerSubtitle =>
      'Danserne skifter partner hver gang igennem';
  ...
  String get danceEditorTransitiveGroup =>
      'Inkludér i gruppen af relaterede danse';

  @override
  String get danceEditorTransitiveGroupHint =>
      'Alle danse i denne gruppe bliver forbundet med hinanden.';
