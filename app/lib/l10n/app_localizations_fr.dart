...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get danceEditorAddedModifierAnnouncement =>
      'Conteneur de modificateur ajouté.';
  ...
  @override
  String get settingsProgramTitle => 'Programme';
  ...
  String get settingsSyncExcludeImportsTitle =>
      'Ignorer les danses importées absentes d\'un programme';

  @override
  String get settingsSyncExcludeImportsSubtitle =>
      'Désactivé par défaut. Réduit ce que cet appareil envoie si vous avez une grande collection importée ; une danse figurant dans l\'un de vos programmes est toujours incluse. Rien n\'est supprimé de vos autres appareils.';
  ...
  String get settingsSyncStatusStoreUnavailable =>
      'Cet espace a peut-être expiré par inactivité ou a été supprimé.';
  ...
  @override
  String get settingsGeneralProgramsHeader => 'Programmes';

  @override
  String get settingsGeneralMatrixExactCollisionTitle =>
      'Signaler uniquement un chevauchement exact des temps';
  ...
  String get settingsProgramVenueCallCountTitle =>
      'Lieux répétés dans l’historique des appels';

  @override
  String get settingsProgramVenueCallCountSubtitle =>
      'Afficher les principaux lieux où une danse a été appelée plusieurs fois. Régler sur 0 pour masquer ce résumé.';
  ...
  @override
  String get commonDanceStatusDraft => 'Brouillon';
  ...
  String get danceCallingHistoryError =>
      'Impossible de charger l\'historique des soirées.';
  ...
  String danceVenueCallCount(int count, String venue) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Appelée $count fois à $venue',
      one: 'Appelée 1 fois à $venue',
    );
    return '$_temp0';
  }
  ...
  @override
  String get programsPlannedTimingHeader => 'Durées prévues';

  @override
  String get programsWalkthroughMinutesLabel =>
      'Minutes de déroulé (facultatif)';

  @override
  String get programsDanceMinutesLabel => 'Minutes de danse (facultatif)';
  ...
  String programsMatrixSectionRowHeaderSemantic(
    ...
    String _temp0 = intl.Intl.selectLogic(section, {
      'none': 'Danse alternative : $title',
      'other': 'Danse alternative : $title, section $section',
    });
    String _temp1 = intl.Intl.selectLogic(section, {
      'none': 'Danse : $title',
      'other': 'Danse : $title, section $section',
    });
    String _temp2 = intl.Intl.selectLogic(alt, {
      'yes': '$_temp0',
      'other': '$_temp1',
  ...
  String programsMatrixSectionChipQualifiedTitle(
    ...
    String _temp0 = intl.Intl.selectLogic(section, {
      'none': '$title (danse alternative)',
      'other': '$title (danse alternative, section $section)',
    });
    String _temp1 = intl.Intl.selectLogic(section, {
      'none': '$title',
  ...
  @override
  String get performWalkthroughCompleteSuffix => ' déroulé terminé';
  ...
  @override
  String get exportJsonDialogTitle => 'Exporter JSON';

  @override
  String get exportJsonDialogMessage =>
      'Choisissez comment fournir ce fichier JSON.';

  @override
  String get exportJsonSave => 'Enregistrer';

  @override
  String get exportJsonCopy => 'Copier le JSON brut';
  ...
  @override
  String get exportJsonCopied => 'JSON copié dans le presse-papiers.';
  ...
  @override
  String get exportJsonSavedGeneric => 'Fichier JSON enregistré.';

  @override
  String exportJsonSavedTo(String fileName, String destination) {
    return '\"$fileName\" enregistré dans $destination.';
  }

  @override
  String get exportJsonSaveError =>
      'Impossible d\'enregistrer ce fichier JSON.';

  @override
  String get exportJsonCopyError => 'Impossible de copier ce JSON.';

  @override
  String get exportJsonShareError => 'Impossible de partager ce fichier JSON.';
  ...
  String get danceEditorTransitiveGroup =>
      'Inclure dans le groupe de danses associées';

  @override
  String get danceEditorTransitiveGroupHint =>
      'Toutes les danses de ce groupe seront liées entre elles.';
  ...
  @override
  String get danceEditorConvertToMeanwhile => 'Convertir en meanwhile';

  @override
  String get danceEditorConvertToModifier => 'Convertir en modificateur';

  @override
  String get danceEditorUngroupMeanwhile => 'Dissocier le meanwhile';

  @override
  String get danceEditorUngroupModifier => 'Dissocier le modificateur';
  ...
  @override
  String get danceEditorModifierCoreLabel => 'Noyau';

  @override
  String get danceEditorModifierChildLabel => 'Modificateur';

  @override
  String get danceEditorModifierCoreSemantic =>
      'Figure noyau du groupe modificateur.';

  @override
  String danceEditorModifierChildSemantic(int number, int total) {
    return 'Figure modificateur $number sur $total.';
  }

  @override
  String get danceEditorRemoveModifierCore => 'Supprimer la figure principale';

  @override
  String get danceEditorRemoveModifierChild =>
      'Supprimer la figure modificateur';
  ...
  String get dialectEditorDiscouragedResetTitle =>
      'Restaurer les termes déconseillés par défaut ?';

  @override
  String get dialectEditorDiscouragedResetBody =>
      'Cela remplace vos termes déconseillés actuels par les valeurs par défaut.';

  @override
  String get dialectEditorExitTitle => 'Enregistrer les modifications ?';

  @override
  String get dialectEditorExitBody =>
      'Vous avez des modifications non enregistrées dans ce dialecte.';

  @override
  String get dialectEditorSaveAndExit => 'Enregistrer et quitter';

  @override
  String get dialectEditorExitWithoutSaving => 'Quitter sans enregistrer';
  ...
  @override
  String get danceReimport => 'Réimporter la chorégraphie';

  @override
  String get danceReimportJson => 'JSON de Callers Compendium';

  @override
  String get danceReimportNoResults =>
      'Aucune danse correspondante trouvée. Choisissez une autre source ou réessayez plus tard.';

  @override
  String get danceReimportChooseResult => 'Choisissez la danse à réimporter';

  @override
  String get danceReimportProgramArchive =>
      'Ce fichier contient un programme et ne peut pas servir à réimporter une seule danse.';

  @override
  String get danceReimportInvalidJson =>
      'Choisissez un fichier valide contenant exactement une danse.';

  @override
  String get danceReimportSourceFailed =>
      'Impossible de charger une danse depuis cette source. Veuillez réessayer.';

  @override
  String get danceReimported => 'Chorégraphie mise à jour.';
  ...
  @override
  String get publishedCollectionsTitle => 'Collections publiées';

  @override
  String get importSourceLabelPublishedCollection => 'Collection publiée';

  @override
  String get publishedCollectionsDescription =>
      'Importez des collections de danses signées et immuables depuis Compendium Analect.';

  @override
  String get publishedCollectionsLoading =>
      'Chargement des collections publiées…';

  @override
  String get publishedCollectionsUnavailable =>
      'Les collections publiées sont temporairement indisponibles.';

  @override
  String get publishedCollectionImport => 'Importer la collection';

  @override
  String get publishedCollectionUnsupported =>
      'Cette collection nécessite une version plus récente de l’application.';

  @override
  String publishedCollectionImportedVersion(String version) {
    return 'Version importée : $version';
  }

  @override
  String publishedCollectionHeldCount(int held, int total) {
    return '$held danses sur $total conservées';
  }
  ...
  String dialectEditorMoveWordingOptionalSlots(String slots) {
    return 'Ce modèle omet des emplacements facultatifs : $slots';
  }
  ...
  String get dialectEditorMoveWordingsResetTitle =>
      'Réinitialiser les modèles de formulation des mouvements ?';

  @override
  String get dialectEditorMoveWordingsResetBody =>
      'Cela supprime tous vos modèles personnalisés de formulation des mouvements.';
