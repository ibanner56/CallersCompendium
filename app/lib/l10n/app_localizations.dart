...
abstract class AppLocalizations {
  ...
  /// General-settings section header for library preferences.
  ///
  /// In en, this message translates to:
  /// **'Library'**
  String get settingsGeneralLibraryHeader;

  /// Toggle title: ignore leading articles when sorting the dance list.
  ///
  /// In en, this message translates to:
  /// **'Ignore leading articles when sorting'**
  String get settingsGeneralIgnoreArticlesTitle;

  /// Explanation for the ignore-leading-articles sort toggle. The quoted words are English article examples.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralIgnoreArticlesSubtitle;

  /// General-settings section header for performance preferences.
  ///
  /// In en, this message translates to:
  /// **'Performance'**
  String get settingsGeneralPerformanceHeader;

  /// Toggle title: auto-size the cards on the Perform screen.
  ///
  /// In en, this message translates to:
  /// **'Auto-size Perform cards'**
  String get settingsGeneralAutoSizeTitle;

  /// Explanation for the auto-size Perform cards toggle. 'A- / A+' are the on-screen zoom controls.
  ///
  /// In en, this message translates to:
  /// **'Scale each card so the full dance or slot fits the screen without scrolling. Turn off to set the size yourself with A- / A+.'**
  String get settingsGeneralAutoSizeSubtitle;
  ...
  /// Toggle title: require the mark-performed flag before a program counts toward calling history.
  ///
  /// In en, this message translates to:
  /// **'Require “mark performed” for calling history'**
  String get settingsGeneralRequirePerformedTitle;

  /// Explanation for the require-mark-performed toggle.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralRequirePerformedSubtitle;
  ...
  /// Toggle title: reduce non-essential animation.
  ///
  /// In en, this message translates to:
  /// **'Reduce motion'**
  String get settingsGeneralReduceMotionTitle;

  /// Explanation for the reduce-motion toggle.
  ///
  /// In en, this message translates to:
  ...
  /// Toggle title: always show verbose figure wording on screen.
  ///
  /// In en, this message translates to:
  /// **'Always show verbose figure text'**
  String get settingsGeneralVerboseFiguresTitle;

  /// Explanation for the verbose-figure-text toggle.
  ///
  /// In en, this message translates to:
  ...
  /// Toggle title: show turn/rotation amounts as decimals.
  ///
  /// In en, this message translates to:
  /// **'Show turns as decimals'**
  String get settingsGeneralDecimalTurnsTitle;

  /// Explanation for the decimal-turns toggle. '(0.75)' and '(¾)' are number-format examples.
  ///
  /// In en, this message translates to:
  ...
  /// Toggle title: confirm before deleting a dance or program.
  ///
  /// In en, this message translates to:
  /// **'Confirm before delete'**
  String get settingsGeneralConfirmDeleteTitle;

  /// Explanation for the confirm-before-delete toggle.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralConfirmDeleteSubtitle;

  /// General-settings section header for deleted-item retention.
  ///
  /// In en, this message translates to:
  /// **'Deleted items'**
  String get settingsGeneralDeletedItemsHeader;

  /// Title of the soft-delete retention-window picker.
  ///
  /// In en, this message translates to:
  /// **'Keep deleted dances for'**
  String get settingsGeneralRetentionTitle;

  /// Explanation for the soft-delete retention picker. 'Never' is the never-auto-purge option.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralRetentionSubtitle;

  /// A soft-delete retention option expressed as a number of days.
  ///
  /// In en, this message translates to:
  /// **'{days} days'**
  String settingsGeneralRetentionDays(int days);

  /// Soft-delete retention option: never auto-purge deleted dances.
  ///
  /// In en, this message translates to:
  /// **'Never'**
  String get settingsGeneralRetentionNever;

  /// General-settings section header for import tools.
  ///
  /// In en, this message translates to:
  /// **'Import'**
  String get settingsGeneralImportHeader;

  /// Title of the import-dances launcher row.
  ///
  /// In en, this message translates to:
  /// **'Import dances'**
  String get settingsGeneralImportDancesTitle;

  /// Explanation for the import-dances launcher.
  ///
  /// In en, this message translates to:
  ...
  /// Button label that opens the import flow.
  ///
  /// In en, this message translates to:
  /// **'Import…'**
  String get settingsGeneralImportButton;

  /// Title of the re-check-custom-figures launcher row.
  ///
  /// In en, this message translates to:
  /// **'Re-check custom figures'**
  String get settingsGeneralReparseTitle;

  /// Explanation for the re-check-custom-figures launcher.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralReparseSubtitle;

  /// Button label that opens the re-check-custom-figures flow.
  ///
  /// In en, this message translates to:
  /// **'Re-check…'**
  String get settingsGeneralReparseButton;

  /// General-settings section header for backup and restore.
  ///
  /// In en, this message translates to:
  /// **'Backup & restore'**
  String get settingsGeneralBackupHeader;

  /// Shown as the last-backup line when no backup has been exported yet.
  ///
  /// In en, this message translates to:
  /// **'Last backup: never'**
  String get settingsGeneralLastBackupNever;

  /// Shows the date of the most recent backup export.
  ///
  /// In en, this message translates to:
  /// **'Last backup: {date}'**
  String settingsGeneralLastBackupDate(String date);

  /// Title of the export-a-backup row.
  ///
  /// In en, this message translates to:
  /// **'Export a backup'**
  String get settingsGeneralExportTitle;

  /// Explanation for the export-a-backup action.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralExportSubtitle;

  /// Button label that exports a backup file.
  ///
  /// In en, this message translates to:
  /// **'Export'**
  String get settingsGeneralExportButton;

  /// Title of the restore-from-a-backup row and the restore dialog.
  ///
  /// In en, this message translates to:
  /// **'Restore from a backup'**
  String get settingsGeneralRestoreTitle;

  /// Explanation for the restore-from-a-backup action.
  ///
  /// In en, this message translates to:
  /// **'Replace everything currently in the app with the contents of a backup file. This cannot be undone.'**
  String get settingsGeneralRestoreSubtitle;

  /// Button label that opens the restore-from-a-backup dialog.
  ///
  /// In en, this message translates to:
  /// **'Restore'**
  String get settingsGeneralRestoreButton;

  /// Title of the backup-reminder cadence picker.
  ///
  /// In en, this message translates to:
  /// **'Backup reminder'**
  String get settingsGeneralReminderTitle;

  /// Backup-reminder cadence option: no reminders.
  ///
  /// In en, this message translates to:
  /// **'Off'**
  String get settingsGeneralReminderOff;

  /// Backup-reminder cadence option: weekly.
  ///
  /// In en, this message translates to:
  /// **'Weekly'**
  String get settingsGeneralReminderWeekly;

  /// Backup-reminder cadence option: monthly.
  ///
  /// In en, this message translates to:
  /// **'Monthly'**
  String get settingsGeneralReminderMonthly;

  /// Gentle hint shown when a backup is overdue relative to the chosen reminder cadence.
  ///
  /// In en, this message translates to:
  /// **'It\'s been a while since your last backup — consider exporting one now.'**
  String get settingsGeneralBackupOverdue;

  /// Destructive-replace warning shown in the restore dialog.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralRestoreDialogWarning;

  /// Button in the restore dialog that opens the native file picker.
  ///
  /// In en, this message translates to:
  /// **'Choose file…'**
  String get settingsGeneralRestoreChooseFile;

  /// Text-field label in the restore dialog for pasting backup JSON directly.
  ///
  /// In en, this message translates to:
  /// **'Or paste backup JSON'**
  String get settingsGeneralRestorePasteLabel;

  /// Confirm button in the restore dialog that applies the destructive replace.
  ///
  /// In en, this message translates to:
  /// **'Replace all data'**
  String get settingsGeneralRestoreConfirm;

  /// Snackbar shown after a backup is successfully exported.
  ///
  /// In en, this message translates to:
  /// **'Backup exported.'**
  String get settingsGeneralBackupExported;

  /// Snackbar shown when exporting a backup fails.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t export a backup.'**
  String get settingsGeneralBackupExportFailed;

  /// Snackbar shown when a restore is refused because the backup has items this app version can't read.
  ///
  /// In en, this message translates to:
  ...
  String get settingsGeneralRestoreIncomplete;

  /// Snackbar shown when the chosen file is not a valid backup.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t restore: the file isn\'t a valid backup. Your data is unchanged.'**
  String get settingsGeneralRestoreInvalid;

  /// Snackbar shown after a restore that skipped some problematic items. 'problem(s)' is intentionally left un-pluralized to match the pre-localization wording.
  ///
  /// In en, this message translates to:
  /// **'Backup restored with {count} problem(s) skipped.'**
  String settingsGeneralRestoredWithProblems(int count);

  /// Snackbar shown after a successful restore.
  ///
  /// In en, this message translates to:
  /// **'Backup restored.'**
  String get settingsGeneralRestored;

  /// Snackbar shown when restoring a backup fails unexpectedly.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t restore the backup.'**
  String get settingsGeneralRestoreFailed;
