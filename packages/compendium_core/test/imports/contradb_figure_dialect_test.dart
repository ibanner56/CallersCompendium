...
void main() {
  ...
  group('contraDbHtmlFigureFrontEnd — batch 2 moves', () {
    ...
    test(
      ...
      () {
        final f = _parse(
          'single file promenade along to the same neighbors',
        );
    ...
    test(
      'single file promenade — no destination param when no tail',
      () {
    ...
    test(
      'single file promenade — unrecognised tail stays as note',
      () {
