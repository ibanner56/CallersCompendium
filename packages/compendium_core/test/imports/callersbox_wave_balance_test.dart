...
void main() {
  ...
  group('dancer-qualified balance folds when who agrees, stays custom when not', () {
    ...
    test('dance 18878 A1: Men walk forward → form long wave + Men balance → '
        'single form_a_long_wave beats=8, no trailing custom', () async {
      final figures = await _figuresFor([
    ...
    test('a dancer-qualified balance whose prefix DISAGREES with the wave who '
        'does NOT fold, stays custom', () async {
    ...
    test('a dancer-qualified balance whose prefix disagrees with the TAXONOMY '
        'DEFAULT who does NOT fold, stays custom', () async {
    ...
    test('a dancer-qualified balance whose prefix AGREES with the taxonomy '
        'default who folds', () async {
