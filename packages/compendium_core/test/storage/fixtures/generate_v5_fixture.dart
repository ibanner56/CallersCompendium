...
// SQLite — drop the CC-parity `dances.rating` column — and reset
// `user_version` to 5. The result is byte-for-byte a schema-v5 database seeded
// with a dance plus a program, so the migration test can assert those rows
// survive and the new `dances.rating` column defaults to NULL.
import 'dart:io';
