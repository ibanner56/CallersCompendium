...
class BaselineState extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  BaselineState(this.attachedDatabase, [this._alias]);
  ...
  @override
  BaselineState createAlias(String alias) {
    return BaselineState(attachedDatabase, alias);
  }
...
class BaselineEntries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  BaselineEntries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  @override
  BaselineEntries createAlias(String alias) {
    return BaselineEntries(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(kind, record_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class IdAliases extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  IdAliases(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  @override
  IdAliases createAlias(String alias) {
    return IdAliases(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(kind, losing_id)'];
  @override
  bool get dontWriteConstraints => true;
}

class PendingDeletions extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PendingDeletions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> tombstonedAt = GeneratedColumn<int>(
    'tombstoned_at',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  PendingDeletions createAlias(String alias) {
    return PendingDeletions(attachedDatabase, alias);
  }
...
class ReviewQueue extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ReviewQueue(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  @override
  ReviewQueue createAlias(String alias) {
    return ReviewQueue(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(kind, record_id, counterpart_id)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class PublishedRecords extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PublishedRecords(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> kind = GeneratedColumn<String>(
    'kind',
    aliasedName,
    false,
  ...
  @override
  PublishedRecords createAlias(String alias) {
    return PublishedRecords(attachedDatabase, alias);
  }
...
class DatabaseAtV32 extends GeneratedDatabase {
  ...
  late final BaselineState baselineState = BaselineState(this);
  late final BaselineEntries baselineEntries = BaselineEntries(this);
  late final IdAliases idAliases = IdAliases(this);
  late final PendingDeletions pendingDeletions = PendingDeletions(this);
  late final ReviewQueue reviewQueue = ReviewQueue(this);
  late final PublishedRecords publishedRecords = PublishedRecords(this);
