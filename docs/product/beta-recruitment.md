...
- **Data situation** — some coming fresh, some migrating from **Caller's Companion**
  or importing from **The Caller's Box** / **ContraDB**, so the import paths get
  real use.

We are explicitly welcoming to callers of every background. Recruitment copy uses
role-neutral language and never assumes a tester's experience level or tools.

## What we ask of testers, and what they get

Being upfront about the deal keeps expectations healthy:
...
We go where callers already are, and we lead with respect for each space's norms
(read the room, follow posting rules, and never spam):

| Channel | Why it fits | Notes |
|---|---|---|
| [Shared Weight](https://www.sharedweight.net/) callers' list | The central gathering of working contra callers | The primary channel; use the longer, conversational template |
| Facebook contra groups | Broad reach across regional and general contra communities | Post where group rules allow; keep it short and friendly |
| [CDSS](https://cdss.org/) channels | Country Dance and Song Society reaches the wider trad-dance world | Follow their community-post guidelines; frame as a community resource |
| Regional dance listservs | Local callers who run series and can test at real gigs | Personalize with the region's name; ask organizers before posting |

Word of mouth matters most of all: a note to callers we already know, and an ask to
pass the call along, will do more than any single post.

## How to run it

1. **Prep the landing spot.** Make sure the
   [beta guide](../beta/beta-guide.md) and
   [test charter](../beta/test-charter.md) are live and
   [Discussions](https://github.com/ibanner56/CallersCompendium/discussions) is open
   as the place to say hello.
2. **Post the call** in the channels above, tailoring each template.
3. **Welcome people in Discussions** — help with setup, point them at a charter,
   and thank them.
...
Fill in the bracketed bits. Keep links intact. Trim to fit each venue's norms.

### Shared Weight (callers' list)

> **Subject: Beta testers wanted: Caller's Compendium, a free, local-first app for callers**
>
> Hi all,
>
...
>
> - **It's yours.** Local-first — your collection lives on your own device, works
>   fully offline, no account to create, and **no telemetry or tracking of any
>   kind**. Nothing phones home.
> - **Your data is portable.** One-file backup and restore is built in, so you're
>   never locked in, and you can move between devices freely.
> - **It speaks your language.** Role names and wording are configurable
>   (Larks/Robins by default, Leads/Follows ready to pick, or your own terms).
> - **It imports** from The Caller's Box, ContraDB, and Caller's Companion, so you
>   don't start from scratch.
> - **It's free**, under the AGPL, because calling resources shouldn't sit behind a
>   paywall.
>
...
### Facebook contra groups

> **Beta testers wanted — a free, private-by-design app for callers 🎶**
>
...
> from The Caller's Box, ContraDB, and Caller's Companion.
>
> If you'd try it at your own dances and share honest feedback, I'd love your help.
> Details: https://github.com/ibanner56/CallersCompendium/blob/main/docs/beta/beta-guide.md
>
> Questions welcome in the comments or in the project's Discussions. Thank you! 💃🕺

### CDSS channels

> **Community call: help test a free, open-source app for dance callers**
>
> **Caller's Compendium** is a free, open-source tool for contra-dance callers —
> for keeping a collection of dances, building programs for events, and calling
> live from a large-print, accessible **Perform mode**. It's built in the spirit of
...
> grateful for your help. Start here:
> https://github.com/ibanner56/CallersCompendium/blob/main/docs/beta/beta-guide.md

### Regional dance listserv

> **Subject: [Region] callers — want to help test a free calling app?**
>
> Hi [region] friends,
>
...
> https://github.com/ibanner56/CallersCompendium/blob/main/docs/beta/beta-guide.md
> — and feel free to reply directly with questions.
>
...
- [Beta guide](../beta/beta-guide.md) — where every recruitment link points.
- [Test charter](../beta/test-charter.md) — what we ask testers to try.
- [Triage rubric](../beta/triage-rubric.md) — how their feedback is handled.
