...
Project synchronization uses a classic personal access token with `project`
scope in the `DEVICE_SYNC_PROJECT_TOKEN` Actions secret. The repository token
cannot write a user-owned Project, and no privileged workflow checks out or
